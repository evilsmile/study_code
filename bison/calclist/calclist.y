...
value: NUMBER { printf("NUM:%lf\n", $1); $$ = new_calclist_num($1); }
	| STRING { $$ = new_calclist_string($1); }
;

key: KEY { printf("Key:%s\n", $1);$$ = new_calclist_key($1); }
;
...
exp: key op value {  printf("op: %d\n",$2); $$ = new_calclist_ast($2, $1, $3); }
	| '(' exp ')'  { $$ = $2; }
;
...
result: result bin_op exp { $$ = new_calclist_ast($2, $1, $3); }
	| exp  { $$ = $1; }
;	
